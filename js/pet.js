(function () {
  ...
  function readSize() {
    var s = parseInt(localStorage.getItem("ovpn-pet-size"), 10);
  ...
  var COLOR_COUNT = 6;
  var petColor = 0;
  try { petColor = parseInt(localStorage.getItem("ovpn-pet-color"), 10) || 0; }
  ...
  function cyclePetColor() {
    ...
    applyPetColor();
    try {
      if (petColor) localStorage.setItem("ovpn-pet-color", String(petColor));
      else localStorage.removeItem("ovpn-pet-color");
    } catch (e) { /* private mode */ }
  }
  ...
  function applyOpacity() {
    var o = parseInt(localStorage.getItem("ovpn-pet-opacity"), 10);
    if (!(o >= 15 && o <= 100)) o = 70;
    document.documentElement.style.setProperty("--pet-base-opacity", (o / 100).toFixed(3));
  }
  function readCfg() {
    cfgNap = boolKey("ovpn-pet-nap", true);
    cfgFlee = boolKey("ovpn-pet-flee", true);
    cfgRead = boolKey("ovpn-pet-read", true);
    cfgTricks = boolKey("ovpn-pet-tricks", true);
    cfgSpeech = boolKey("ovpn-pet-speech", false);
    var c = parseInt(localStorage.getItem("ovpn-pet-color"), 10);
