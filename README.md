<p align="center">
  <picture>
    ...
    <img src="docs/assets/cover-light.svg" alt="OpenVPN Inspector — Read An .Ovpn Config · Decode Its Certificates, in the Terminal Workbench style" width="100%">
  </picture>
</p>

<p align="center">
  <a href="https://real-fruit-snacks.github.io/openvpn-inspector/"><strong>Live site</strong></a> ·
...
Paste or open an .ovpn file (or a .crt/.pem) and see every certificate's expiry, details, and config security flags — entirely in your browser. Styled with the
...
- Paste or open an .ovpn file (or a .crt / .pem) and see every directive explained.
- Decodes embedded X.509 certificates — subject, issuer, validity, key details.
- Flags risky or insecure settings. Everything is parsed locally; nothing is uploaded.
...
**Offline / airgapped:** grab the zip from the [latest release](https://github.com/Real-Fruit-Snacks/openvpn-inspector/releases/latest)
...
| File | Responsibility |
|---|---|
| `js/x509.js` | tool logic and UI |
| `js/samples.js` | tool logic and UI |
